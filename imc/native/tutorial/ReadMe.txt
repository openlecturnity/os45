========================================================================
       MICROSOFT FOUNDATION CLASS BIBLIOTHEK : tutorial
========================================================================


Diese tutorial-Anwendung hat der Klassen-Assistent für Sie erstellt. Diese Anwendung
...
Ihre tutorial-Anwendung bilden.
...
res\tutorial.ico
	...
	Symbol wird durch die Haupt-Ressourcendatei tutorial.rc eingebunden.
...
tutorialDlg.h, tutorialDlg.cpp - das Dialogfeld
    	Diese Dateien enthalten die Klasse CTutorialDlg. Diese Klasse legt das
    	Verhalten des Haupt-Dialogfelds der Anwendung fest. Die Vorlage des Dialog-
	felds befindet sich in tutorial.rc, die mit Microsoft Visual C++
...
StdAfx.h, StdAfx.cpp
	...
	tutorial.pch und eine vorkompilierte Typdatei mit der Bezeichnung StdAfx.obj
	erstellt.
