========================================================================
       MICROSOFT FOUNDATION CLASS BIBLIOTHEK : LmdManip
========================================================================


Diese LmdManip-Anwendung hat der Klassen-Assistent für Sie erstellt. Diese Anwendung
...
Ihre LmdManip-Anwendung bilden.
...
res\LmdManip.ico
	...
	Symbol wird durch die Haupt-Ressourcendatei LmdManip.rc eingebunden.
...
LmdManipDlg.h, LmdManipDlg.cpp - das Dialogfeld
    	Diese Dateien enthalten die Klasse CLmdManipDlg. Diese Klasse legt das
    	Verhalten des Haupt-Dialogfelds der Anwendung fest. Die Vorlage des Dialog-
	felds befindet sich in LmdManip.rc, die mit Microsoft Visual C++
...
StdAfx.h, StdAfx.cpp
	...
	LmdManip.pch und eine vorkompilierte Typdatei mit der Bezeichnung StdAfx.obj
	erstellt.
