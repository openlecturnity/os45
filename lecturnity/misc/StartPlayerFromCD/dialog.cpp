...
//   bitmapRect.bottom = 322;
   bitmapRect.left = 2;
   bitmapRect.top = 2;
   bitmapRect.right = 299;
   bitmapRect.bottom = 278;
...
//   separatorRect.bottom = 325;
   separatorRect.left = 2;
   separatorRect.top = 279;
   separatorRect.right = 299;
   separatorRect.bottom = 281;
...
//   buttonRect.bottom = 378;
   buttonRect.left = 2;
   buttonRect.top = 284;
   buttonRect.right = 299;
   buttonRect.bottom = 334;
...
//   yPos = (deskRect.bottom - deskRect.top - 380) / 2;
   xPos = (deskRect.right - deskRect.left - 302) / 2;
   yPos = (deskRect.bottom - deskRect.top - 336) / 2;
...
//      mainWindow_, NULL, hInstance_, NULL);  
   hButton_ = CreateWindowEx( 0, "BUTTON", "Abbrechen", 
      BS_PUSHBUTTON | BS_ICON | WS_CHILD | WS_VISIBLE, 103, 294,
      100,30, 
      mainWindow_, NULL, hInstance_, NULL);  
...
//      SetWindowPos(mainWindow_, HWND_NOTOPMOST, windowRect.left,windowRect.top,340,338,SWP_NOZORDER|SWP_NOMOVE);
      SetWindowPos(mainWindow_, HWND_NOTOPMOST, windowRect.left,windowRect.top,317,294,SWP_NOZORDER|SWP_NOMOVE);
...
//   SetWindowPos(mainWindow_, HWND_TOPMOST, windowRect.left,windowRect.top,340,340,SWP_NOMOVE);
   SetWindowPos(mainWindow_, HWND_TOPMOST, windowRect.left,windowRect.top,317,296,SWP_NOMOVE);
