...
class CHoverButtonEx : public CBitmapButton
{
	...
	// Construction
public:
	CHoverButtonEx(UINT nOnPressMessage);
...
protected:
   ...
   UINT m_WMOnPressButton;
	...
	void DrawTransparentBitmap (HDC hDC, int iState,
...
protected:
   ...
   Gdiplus::Bitmap *Load(int iId);

private:
   
   Gdiplus::Bitmap *m_pBackground;

   Gdiplus::Bitmap *m_pImageNormal;
   Gdiplus::Bitmap *m_pImageMOver;
   Gdiplus::Bitmap *m_pImagePressed;
