// PodcasterDlg.h : header file
//

#if !defined(AFX_PODCASTERDLG_H__612E4EFB_2955_4E26_9FBA_C56014D26772__INCLUDED_)
#define AFX_PODCASTERDLG_H__612E4EFB_2955_4E26_9FBA_C56014D26772__INCLUDED_
...
class CPodcasterDlg : public CDialog
{
// Construction
   // version 2
   // channel
...
public:
   CPodcasterDlg(CWnd* pParent = NULL);   // standard constructor
   BOOL DoSession();
   BOOL DoFtpSession();
   BOOL DoSshSession();
   ...
   // Dialog Data
   //{{AFX_DATA(CPodcasterDlg)
	enum { IDD = IDD_PODCASTER_DIALOG };
...
#endif // !defined(AFX_PODCASTERDLG_H__612E4EFB_2955_4E26_9FBA_C56014D26772__INCLUDED_)
