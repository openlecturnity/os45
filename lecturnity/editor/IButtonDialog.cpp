// IButtonDialog.cpp : implementation file
//
...
IMPLEMENT_DYNAMIC(CIButtonDialog, CDialog)

CIButtonDialog::CIButtonDialog(CWnd* pParent /*=NULL*/)
	: CDialog(CIButtonDialog::IDD, pParent)
{

    m_bIsInitialized = false;
}

CIButtonDialog::~CIButtonDialog()
{
}

void CIButtonDialog::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(CIButtonDialog, CDialog)
    ON_WM_SIZE()
    ON_WM_GETMINMAXINFO()
    ON_BN_CLICKED(IDOK, &CIButtonDialog::OnBnClickedOk)
END_MESSAGE_MAP()


// CIButtonDialog message handlers
...
void CIButtonDialog::InitChildWin(CDialog* pDlg, UINT iWinID){
...
BOOL CIButtonDialog::PreTranslateMessage(MSG* pMsg)
{
...
void CIButtonDialog::OnGetMinMaxInfo(MINMAXINFO* lpMMI)
{
...
void CIButtonDialog::Init(CInteractionAreaEx *pInteractionButton, CRect &rcArea, CEditorProject *pProject){
    m_dlgInside.Init(pInteractionButton, rcArea, pProject);
}

void CIButtonDialog::SetUserEntries(CRect &rcArea, CInteractionAreaEx *pInteraction) {
    m_dlgInside.SetUserEntries(rcArea, pInteraction);
}

BOOL CIButtonDialog::ContinueModal()
{
    // TODO: Add your specialized code here and/or call the base class
...
void CIButtonDialog::RepositionControls() 
{
        CRect rcWin;
        GetWindowRect(&rcWin);
...
void CIButtonDialog::OnBnClickedOk()
{
    // TODO: Add your control notification handler code here
    if (m_dlgInside.GetSafeHwnd())
    {
        m_dlgInside.OnBtnClickOK();//OnOK();
    }
    OnOK();
}
