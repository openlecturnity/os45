========================================================================
       MICROSOFT FOUNDATION CLASS BIBLIOTHEK : editor
========================================================================


Diese editor-Anwendung hat der Klassen-Assistent für Sie erstellt. Diese Anwendung
...
res\editor.ico
	...
	Symbol wird durch die Haupt-Ressourcendatei editor.rc eingebunden.
...
editorDoc.h, editorDoc.cpp - das Dokument
    	Diese Dateien enthalten die Klasse CEditorDoc. Bearbeiten Sie diese Dateien,
  	um Ihre speziellen Dokumentdaten hinzuzufügen und das Speichern und Laden von 
	Dateien zu implementieren (mit Hilfe von CEditorDoc::Serialize).

editorView.h, editorView.cpp - die Ansicht des Dokuments
    	Diese Dateien enthalten die Klasse CEditorView.
    	CEditorView-Objekte werden verwendet, um CEditorDoc-Objekte anzuzeigen.
...
StdAfx.h, StdAfx.cpp
	...
	editor.pch und eine vorkompilierte Typdatei mit der Bezeichnung StdAfx.obj
	erstellt.
